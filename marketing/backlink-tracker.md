...
| 9 | buy.nsw supplier profile (NSW Government) | https://buy.nsw.gov.au/supplier/profile/12460268 | live | — | (registered prior to this tracker) | Aescia Pty Ltd is a registered supplier on the NSW Government buy.nsw marketplace (supplier profile 12460268), a `.gov.au` inbound link to aesciahealth.com. Reciprocated on-site 2026-06-14: profile URL added to Organization `sameAs` and a `NSW Government Supplier ID (buy.nsw)` identifier in `lib/schema.ts`, plus a visible "NSW Government registered supplier" link in the site footer Legal column. |
| 10 | Crunchbase company profile | https://www.crunchbase.com/organization/aescia-health | live | — | (created prior to this tracker) | Crunchbase profile is live and populated; linked via Organization `sameAs` in `lib/schema.ts`. Verified live 2026-06-24. Profile copy source: `external-profiles/wellfound-crunchbase.md`. Action: live profile body still shows the superseded dual-entity (Ontario / Québec) structure; update to standalone Aescia Pty Ltd (AU). |
