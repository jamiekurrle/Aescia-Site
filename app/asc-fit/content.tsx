    ...
    <>
      ...
      <section className="py-20 lg:py-28 px-6 lg:px-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-px bg-border border-y border-border">
          ...
          <div className="bg-background p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              <span className="font-mono text-[13px] uppercase tracking-[0.22em] text-accent">{t('ascfit.bestfit.eyebrow')}</span>
              <span className="h-px w-10 bg-accent/60" aria-hidden="true" />
            </div>
          ...
          <div className="bg-background p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              <span className="font-mono text-[13px] uppercase tracking-[0.22em] text-brass">{t('ascfit.notfit.eyebrow')}</span>
      ...
      <section className="py-20 lg:py-28 px-6 lg:px-10 bg-secondary">
        <div className="max-w-4xl mx-auto">
          <span className="font-mono text-[13px] uppercase tracking-[0.22em] text-accent">{t('ascfit.instead.eyebrow')}</span>
          <h2
