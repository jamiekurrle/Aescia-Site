...
export const metadata: Metadata = {
  ...
  description:
    'Aescia for Clinics reduces colonoscopy no-shows and late cancellations at ambulatory surgery centers by getting more patients correctly prepped and confirmed before the procedure date. Clinician-authored prep pathways, GLP-1 / anticoagulant / diabetic overlays, prep-night photo confirmation. Pre-first-customer; priced per scope, design partners start free.',
