...
import { ROLES, getRole, roleDescriptionHtml, APPLY_EMAIL } from '@/lib/careers'
...
export default async function RolePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const facts: { k: string; v: string }[] = [
    { k: 'Team', v: role.team },
    { k: 'Engagement', v: role.engagement },
    { k: 'Location', v: role.location },
    { k: 'Reports to', v: role.reportsTo },
    ...(role.compensation ? [{ k: 'Compensation', v: role.compensation }] : []),
  ]
      ...
      <main id="main" className="bg-background min-h-screen">
        ...
        <section className="pt-32 pb-16 lg:pt-40 lg:pb-20 px-6 lg:px-10 border-b border-border">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-7">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-accent">Open role</span>
        ...
        <section className="py-12 lg:py-16 px-6 lg:px-10 bg-secondary border-b border-border">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-9">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-foreground/60 mb-3">Stack</p>
        ...
        <section className="py-20 lg:py-28 px-6 lg:px-10">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-5">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-brass">The role</span>
        ...
        <section id="what-you-will-build" className="py-20 lg:py-28 px-6 lg:px-10 bg-secondary scroll-mt-28">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-5">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-accent">Responsibilities</span>
              <span className="h-px w-10 bg-accent/60" aria-hidden="true" />
            </div>
        ...
        <section className="py-20 lg:py-28 px-6 lg:px-10">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-5">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-brass">Requirements</span>
              <span className="h-px w-10 bg-brass/60" aria-hidden="true" />
            </div>
        ...
        <section className="py-20 lg:py-28 px-6 lg:px-10 bg-secondary">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-5">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-accent">Nice to have</span>
              <span className="h-px w-10 bg-accent/60" aria-hidden="true" />
            </div>
            <h2 className={`${SECTION_H2} mb-10`} style={{ fontVariationSettings: "'opsz' 120" }}>
              Bonus points.
        ...
        <section className="py-20 lg:py-28 px-6 lg:px-10">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-5">
              <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-brass">The team</span>
              <span className="h-px w-10 bg-brass/60" aria-hidden="true" />
            </div>
            <h2 className={`${SECTION_H2} mb-9`} style={{ fontVariationSettings: "'opsz' 120" }}>
              How we work.
