...
const CareOrbit = dynamic(() => import('@/components/effects-variants/care-orbit').then((m) => m.CareOrbit), {
  ssr: false,
  loading: () => null,
})

/**
 * EditorialHero with the cohort SVG diagram replaced by a live three.js
 * care-orbit. Same brand palette, same composition.
 */
export function EditorialHeroR3F() {
  const { t } = useI18n()
        ...
        <div className="lg:col-span-5 pt-4 lg:pt-0">
          <div className="relative w-full max-w-[520px] mx-auto">
            <div className="w-full aspect-[5/4]">
              <CareOrbit className="w-full h-full" />
            </div>
            <div className="mt-3 flex justify-between font-mono text-[10px] uppercase tracking-[0.22em] text-background/55">
              <span>Cohort &middot; 30-day window</span>
