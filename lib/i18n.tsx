...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hero.note.body': 'Pre-procedure prep, prep-aware backfill, and recall. Not a medical device.',
    'hero.trial.label': 'Clinical programme',
    'hero.trial.brief': 'SAFE-Discharge, live since June 2026',
    ...
    'trust.item2.value': 'Trial data',
    'trust.item2.label': 'stored in Australia',
    'trust.item3.value': 'Chubb',
    'trust.item3.label': 'liability and cyber insurance',
    ...
    'pillars.dual.desc': 'A regulated pathway for surgical recovery and a workflow pathway for procedural clinics share the same authoring layer and the same team.',

    // Evidence ribbon (home)
    'evidence.eyebrow': 'Where we are today',
    'evidence.title': 'A live trial at Royal Prince Alfred Hospital.',
    'evidence.body': 'Aescia for Hospitals has been in a live trial at Royal Prince Alfred Hospital since June 2026, with good early results. SAFE-Discharge evaluates post-surgical monitoring in the hospital\'s cardiothoracic unit in Sydney. Dr Kei Woldendorp is the Principal Investigator, and Sydney Local Health District sponsors the trial.',
    'evidence.fact1.value': 'ACTRN12625001425482',
    'evidence.fact1.label': 'Trial registration',
    'evidence.fact2.value': 'Live',
    'evidence.fact2.label': 'Since June 2026, Royal Prince Alfred Hospital',
    ...
    'footer.disclosure': 'Aescia for Hospitals is an investigational Software as a Medical Device, intended Class IIa. A regulatory submission is in preparation. The product is in clinical evaluation through the SAFE-Discharge trial and is not yet available for commercial supply. Aescia for Clinics is a workflow platform and is not a medical device.',
    'footer.integrations': 'Integrations',
    'footer.buy': 'Buy',
    'footer.design_partner': 'Design-partner program',
    'footer.roi_calculator': 'ROI calculator',
    'footer.security': 'Security',
    'footer.faq': 'FAQ',
    'footer.privacy': 'Privacy policy',
    'footer.terms': 'Terms of use',
    'footer.nsw_supplier': 'NSW Government registered supplier',
    'footer.nsw_supplier_aria': 'Aescia\'s registered supplier profile on the NSW Government buy.nsw marketplace (opens in a new window)',
    'footer.solutions': 'Solutions',
    'footer.solutions.bowel_prep': 'Bowel prep adequacy',
    'footer.solutions.no_shows': 'Colonoscopy no-shows',
    'footer.solutions.glp1': 'GLP-1 before endoscopy',
    'footer.solutions.meds': 'Blood thinners and diabetes meds',
    'footer.solutions.workflow': 'Pre-procedure workflow',
    'footer.solutions.backfill': 'Prep-aware backfill',
    'footer.solutions.asc_fit': 'ASC fit check',
    'footer.solutions.compare': 'How Aescia compares',
    ...
    'hospitals.status.body': 'Aescia for Hospitals has an intended Class IIa classification. A regulatory application has not yet been lodged. Engagement today is through evaluation and pilot contracts only. This page does not recruit trial participants.',
    ...
    'hospitals.leadership.body': 'Aescia for Hospitals is in clinical evaluation through the SAFE-Discharge trial. The Principal Investigator is a practising cardiothoracic research clinician at the trial site. Advisers are named as each joins and consents.',
    ...
    'hospitals.leadership.woldendorp.role': 'Principal Investigator of the SAFE-Discharge trial at Royal Prince Alfred Hospital, sponsored by Sydney Local Health District.',
    ...
    'hospitals.trial.body': 'A prospective single-centre evaluation of Aescia for cardiothoracic post-discharge monitoring, live at Royal Prince Alfred Hospital since June 2026, with good early results. Registered with the Australian New Zealand Clinical Trials Registry and sponsored by Sydney Local Health District.',
    ...
    'clinics.features.item2.desc': 'Timed reminders in the patient language, a confirm-and-reschedule path built in, a same-day flag your front desk can actually act on. When a slot opens, a prep-ready backfill shortlist for the clinic to offer.',
    ...
    'clinics.features.item5.desc': 'The evening before, the patient can upload a toilet-bowl photo through the web-app. The pathway checks it against a clinician-set rubric and flags whether the prep looks on track, so the clinic can confirm or reschedule before the patient leaves home.',
    ...
    'partners.body': 'Aescia is in a live trial at the Royal Prince Alfred Hospital cardiothoracic unit in Sydney, with research collaborations across named institutes in Australia and Canada. We publish affiliations we have earned, not logo walls.',
    ...
    'partners.item1.role': 'Sydney Local Health District tertiary teaching hospital. Cardiothoracic surgical unit hosts the SAFE-Discharge trial site.',
    ...
    'team.james.role': 'Founder and Chief Executive Officer',
    'team.james.bio': 'A hospital doctor with critical care experience, who trained and practised across rural New South Wales (Wagga Wagga) and Sydney. Authors the clinical pathway engine and leads company strategy.',
    'team.vasken.name': 'Dr Vasken Dermardiros',
    'team.vasken.role': 'Co-founder and Chief Technology Officer',
    'team.vasken.bio': 'PhD from Concordia University in building-energy machine learning. Leads security, hosting, artificial intelligence inference, electronic medical record integration and the pathway authoring infrastructure that underpins both products.',
    'team.operating.eyebrow': 'Company officers',
    'team.operating.title': 'Statutory roles.',
    ...
    'team.clinical.eyebrow': 'Trial leadership',
    'team.clinical.title': 'SAFE-Discharge at Royal Prince Alfred Hospital.',
    'team.clinical.body': 'Aescia for Hospitals has been in a live trial at Royal Prince Alfred Hospital since June 2026, with good early results.',
    'team.kei.name': 'Dr Kei Woldendorp',
    'team.kei.role': 'Principal Investigator of the SAFE-Discharge trial at Royal Prince Alfred Hospital, sponsored by Sydney Local Health District',
    'team.kei.bio': 'BMed MBBS MPhil. Cardiothoracic researcher, The Baird Institute and Royal Prince Alfred Hospital.',
    'team.advisory.eyebrow': 'Advisory',
    'team.advisory.title': 'Advisers.',
    'team.advisory.body': 'Advisers are named as each joins and consents.',
    'team.advisory.body2': 'For enquiries about advisory roles, use the contact page.',
    ...
    'updates.entry11.date': 'June 2026',
    'updates.entry11.tag': 'Trial',
    'updates.entry11.title': 'SAFE-Discharge goes live at Royal Prince Alfred Hospital.',
    'updates.entry11.body': 'SAFE-Discharge, a prospective single-centre evaluation of Aescia for Hospitals in adults recovering from cardiothoracic surgery, went live at the Royal Prince Alfred Hospital cardiothoracic surgical unit in June 2026. It is registered with the Australian New Zealand Clinical Trials Registry and sponsored by Sydney Local Health District.',
    ...
    'updates.entry4.body': 'Application MVPV25RD3347 lodged with Investment NSW on 10 April 2026. Matched-funding programme for commercialisation work. Recipients are expected to be announced later in 2026.',
    ...
    'clinics.proof.stat1.label': 'Patients cancelled for presumed inadequate bowel preparation who completed a colonoscopy or stool test within six months',
    'clinics.proof.stat1.value': '67%',
  ...
  fr: {
    ...
    'hero.title': 'Des patients qui arrivent prêts. Des listes qui tiennent à l\'heure.',
    'hero.subtitle': 'Aescia for Clinics est un logiciel de parcours pré-procédural pour les ASC d\'endoscopie et les cliniques spécialisées : préparation intestinale, gestion des médicaments et des GLP-1, remplissage de créneaux tenant compte de la préparation, et rappels. Aescia for Hospitals ajoute une surveillance post-sortie structurée sur le même moteur de parcours.',
    'hero.cta.primary': 'Voir Aescia for Clinics',
    'hero.cta.secondary': 'Contacter notre équipe',
    'hero.note.label': 'Pour les ASC d\'endoscopie aux États-Unis',
    'hero.note.body': 'Préparation pré-procédurale, remplissage tenant compte de la préparation, et rappels. Pas un dispositif médical.',
    'hero.trial.label': 'Programme clinique',
    'hero.trial.brief': 'SAFE-Discharge, en cours depuis juin 2026',
    'hero.trial.site': 'Royal Prince Alfred Hospital, Sydney',
    ...
    'trust.item2.value': 'Données de l\'essai',
    'trust.item2.label': 'stockées en Australie',
    'trust.item3.value': 'Chubb',
    'trust.item3.label': 'assurance responsabilité civile et cyber',
    ...
    'pillars.dual.desc': 'Un parcours régulé pour la récupération chirurgicale et un parcours de flux de travail pour les cliniques procédurales partagent la même couche d\'édition et la même équipe.',

    'evidence.eyebrow': 'Où nous en sommes',
    'evidence.title': 'Un essai en cours au Royal Prince Alfred Hospital.',
    'evidence.body': 'Aescia pour les hôpitaux fait l\'objet d\'un essai en cours au Royal Prince Alfred Hospital depuis juin 2026, avec de bons premiers résultats. SAFE-Discharge évalue la surveillance post-chirurgicale dans le service de chirurgie cardiothoracique de l\'hôpital, à Sydney. Le Dr Kei Woldendorp en est l\'investigateur principal, et le Sydney Local Health District en est le promoteur.',
    'evidence.fact1.value': 'ACTRN12625001425482',
    'evidence.fact1.label': 'Enregistrement',
    'evidence.fact2.value': 'En cours',
    'evidence.fact2.label': 'Depuis juin 2026, Royal Prince Alfred Hospital',
    ...
    'footer.disclosure': 'Aescia pour les hôpitaux est un logiciel dispositif médical en investigation, Classe IIa prévue. Une demande réglementaire est en préparation. Le produit est en évaluation clinique via l\'essai SAFE-Discharge et n\'est pas encore disponible pour la fourniture commerciale. Aescia pour les cliniques est une plateforme de flux de travail et n\'est pas un dispositif médical.',
    'footer.integrations': 'Intégrations',
    'footer.buy': 'Acheter',
    'footer.design_partner': 'Programme de partenaires de conception',
    'footer.roi_calculator': 'Calculateur de ROI',
    'footer.security': 'Sécurité',
    'footer.faq': 'FAQ',
    'footer.privacy': 'Politique de confidentialité',
    'footer.terms': 'Conditions d\'utilisation',
    'footer.nsw_supplier': 'Fournisseur enregistré auprès du gouvernement de Nouvelle-Galles du Sud',
    'footer.nsw_supplier_aria': 'Profil de fournisseur enregistré d\'Aescia sur la place de marché buy.nsw du gouvernement de Nouvelle-Galles du Sud (s\'ouvre dans une nouvelle fenêtre)',
    'footer.solutions': 'Solutions',
    'footer.solutions.bowel_prep': 'Qualité de la préparation intestinale',
    'footer.solutions.no_shows': 'Absences aux coloscopies',
    'footer.solutions.glp1': 'GLP-1 avant l\'endoscopie',
    'footer.solutions.meds': 'Anticoagulants et médicaments du diabète',
    'footer.solutions.workflow': 'Flux de travail pré-procédural',
    'footer.solutions.backfill': 'Remplissage tenant compte de la préparation',
    'footer.solutions.asc_fit': 'Évaluation d\'adéquation ASC',
    'footer.solutions.compare': 'Comment Aescia se compare',
    ...
    'hospitals.status.body': 'Aescia pour les hôpitaux a une classification Classe IIa prévue. Une demande réglementaire n\'a pas encore été déposée. L\'engagement se fait aujourd\'hui uniquement par contrats d\'évaluation et pilotes. Cette page ne recrute pas de participants à l\'essai.',

    'hospitals.leadership.eyebrow': 'Direction de l\'essai',
    'hospitals.leadership.title': 'L\'investigateur principal de SAFE-Discharge.',
    'hospitals.leadership.body': 'Aescia pour les hôpitaux est en évaluation clinique via l\'essai SAFE-Discharge. L\'investigateur principal est un clinicien-chercheur cardiothoracique en exercice sur le site. Les conseillers sont nommés à mesure que chacun se joint à nous et y consent.',
    'hospitals.leadership.woldendorp.name': 'Dr Kei Woldendorp',
    ...
    'hospitals.leadership.woldendorp.role': 'Investigateur principal de l\'essai SAFE-Discharge au Royal Prince Alfred Hospital, promu par le Sydney Local Health District.',
    ...
    'hospitals.trial.body': 'Une évaluation prospective mono-centrique d\'Aescia pour la surveillance post-sortie cardiothoracique, en cours au Royal Prince Alfred Hospital depuis juin 2026, avec de bons premiers résultats. Enregistrée au Australian New Zealand Clinical Trials Registry et promue par le Sydney Local Health District.',
    ...
    'clinics.features.item2.desc': 'Rappels chronométrés dans la langue du patient, parcours confirmer-et-reprogrammer intégré, un signal jour-même exploitable par votre secrétariat. À l\'ouverture d\'un créneau, une liste restreinte de patients prêts pour la préparation, que la clinique propose.',
    ...
    'clinics.features.item5.desc': 'La veille, le patient peut téléverser une photo de la cuvette via l\'appli web. Le parcours la compare à une grille fixée par le clinicien et signale si la préparation semble en bonne voie, afin que la clinique confirme ou reprogramme avant que le patient ne quitte la maison.',
    ...
    'partners.body': 'Aescia fait l\'objet d\'un essai en cours au service de chirurgie cardiothoracique du Royal Prince Alfred Hospital à Sydney, avec des collaborations de recherche dans des instituts nommés en Australie et au Canada. Nous publions les affiliations que nous avons obtenues, pas des murs de logos.',
    'partners.trial.label': 'Enregistrement de l\'essai',
    'partners.trial.value': 'ACTRN12625001425482',
    'partners.item1.name': 'Royal Prince Alfred Hospital',
    'partners.item1.role': 'Hôpital universitaire tertiaire du Sydney Local Health District. Le service de chirurgie cardiothoracique accueille le site d\'essai SAFE-Discharge.',
    'partners.item2.name': 'The Baird Institute',
    ...
    'team.james.name': 'James Kurrle',
    'team.james.role': 'Fondateur et directeur général',
    'team.james.bio': 'Médecin hospitalier avec une expérience en soins critiques, formé et ayant exercé en Nouvelle-Galles du Sud rurale (Wagga Wagga) et à Sydney. Rédige le moteur de parcours clinique et dirige la stratégie de l\'entreprise.',
    'team.vasken.name': 'Dr Vasken Dermardiros',
    'team.vasken.role': 'Cofondateur et directeur de la technologie',
    'team.vasken.bio': 'Doctorat de l\'Université Concordia en apprentissage automatique pour l\'énergie du bâtiment. Responsable de la sécurité, de l\'hébergement, de l\'inférence d\'intelligence artificielle, de l\'intégration aux dossiers médicaux électroniques et de l\'infrastructure d\'édition des parcours qui sous-tend les deux produits.',
    'team.operating.eyebrow': 'Dirigeants de la société',
    'team.operating.title': 'Fonctions statutaires.',
    'team.shannon.name': 'Shannon Kurrle',
    ...
    'team.clinical.eyebrow': 'Direction de l\'essai',
    'team.clinical.title': 'SAFE-Discharge au Royal Prince Alfred Hospital.',
    'team.clinical.body': 'Aescia pour les hôpitaux fait l\'objet d\'un essai en cours au Royal Prince Alfred Hospital depuis juin 2026, avec de bons premiers résultats.',
    'team.kei.name': 'Dr Kei Woldendorp',
    'team.kei.role': 'Investigateur principal de l\'essai SAFE-Discharge au Royal Prince Alfred Hospital, promu par le Sydney Local Health District',
    'team.kei.bio': 'BMed MBBS MPhil. Chercheur en chirurgie cardiothoracique, The Baird Institute et Royal Prince Alfred Hospital.',
    'team.advisory.eyebrow': 'Conseil',
    'team.advisory.title': 'Conseillers.',
    'team.advisory.body': 'Les conseillers sont nommés à mesure que chacun se joint à nous et y consent.',
    'team.advisory.body2': 'Pour toute demande concernant les rôles de conseiller, utilisez la page contact.',
    ...
    'updates.entry15.date': '17 août 2026',
    'updates.entry15.tag': 'Subventions',
    'updates.entry15.title': 'Subvention de démarrage de St. Boniface accordée à l\'étude TPD-CONNECT.',
    'updates.entry15.body': 'La Dre Shuangbo Liu, de l\'Hôpital Saint-Boniface à Winnipeg, a obtenu une subvention de démarrage en recherche cardiovasculaire de Saint-Boniface, financée par le National Bank Cardiac Classic, pour TPD-CONNECT. Il s\'agit d\'une étude de 12 mois qui conçoit et prototype, avec les patients, un soutien post-sortie adapté en cardiologie. Aescia y est collaboratrice désignée et assure la configuration de la plateforme ainsi que la réalisation du prototype. La Dre Liu est la demandeuse principale et les travaux se déroulent à Saint-Boniface.',
    ...
    'updates.entry11.date': 'Juin 2026',
    'updates.entry11.tag': 'Essai',
    'updates.entry11.title': 'SAFE-Discharge démarre au Royal Prince Alfred Hospital.',
    'updates.entry11.body': 'SAFE-Discharge, une évaluation prospective mono-centrique d\'Aescia for Hospitals chez des adultes en convalescence après une chirurgie cardiothoracique, a démarré à l\'unité de chirurgie cardiothoracique du Royal Prince Alfred Hospital en juin 2026. L\'essai est enregistré auprès du Australian New Zealand Clinical Trials Registry et promu par le Sydney Local Health District.',
    ...
    'updates.entry4.body': 'Demande MVPV25RD3347 déposée auprès d\'Investment NSW le 10 avril 2026. Programme de financement à part égale pour des travaux de commercialisation. Les bénéficiaires devraient être annoncés plus tard en 2026.',
    ...
    'clinics.proof.stat1.label': 'Patients annulés pour préparation intestinale présumée inadéquate ayant réalisé une coloscopie ou un test de selles dans les six mois',
    'clinics.proof.stat1.value': '67 %',
    'clinics.proof.stat1.source': 'Hopkins 2020, Boston Medical Center (3 % annulés pour PIBP, 67 % complétés dans les 6 mois)',
    ...
    'clinics.proof.stat2.source': 'Wang 2023, Transparency in Coverage (989 à 1 034 $ US, n=17 052 tarifs ASC)',
  ...
  es: {
    ...
    'hero.title': 'Pacientes que llegan preparados. Listas que cumplen su horario.',
    'hero.subtitle': 'Aescia for Clinics es software de vías pre-procedimiento para ASC de endoscopia y clínicas especializadas: preparación intestinal, manejo de medicación y GLP-1, relleno de huecos según la preparación, y recitación. Aescia for Hospitals añade monitorización posalta estructurada sobre el mismo motor de vías.',
    'hero.cta.primary': 'Ver Aescia for Clinics',
    'hero.cta.secondary': 'Hablar con nuestro equipo',
    'hero.note.label': 'Para ASC de endoscopia en EE. UU.',
    'hero.note.body': 'Preparación pre-procedimiento, relleno según la preparación, y recitación. No es un dispositivo médico.',
    'hero.trial.label': 'Programa clínico',
    'hero.trial.brief': 'SAFE-Discharge, en marcha desde junio de 2026',
    ...
    'trust.item2.value': 'Datos del ensayo',
    'trust.item2.label': 'almacenados en Australia',
    'trust.item3.value': 'Chubb',
    'trust.item3.label': 'seguro de responsabilidad civil y ciberseguro',
    ...
    'pillars.dual.desc': 'Una vía regulada para la recuperación quirúrgica y una vía de flujo de trabajo para clínicas de procedimientos comparten la misma capa de edición y el mismo equipo.',

    'evidence.eyebrow': 'Dónde estamos hoy',
    'evidence.title': 'Un ensayo en marcha en el Royal Prince Alfred Hospital.',
    'evidence.body': 'Aescia para Hospitales está en un ensayo en marcha en el Royal Prince Alfred Hospital desde junio de 2026, con buenos resultados iniciales. SAFE-Discharge evalúa la monitorización posquirúrgica en la unidad cardiotorácica del hospital, en Sídney. El Dr. Kei Woldendorp es el investigador principal y el Sydney Local Health District es el promotor del ensayo.',
    'evidence.fact1.value': 'ACTRN12625001425482',
    'evidence.fact1.label': 'Registro del ensayo',
    'evidence.fact2.value': 'En marcha',
    'evidence.fact2.label': 'Desde junio de 2026, Royal Prince Alfred Hospital',
    ...
    'footer.disclosure': 'Aescia para Hospitales es un software como dispositivo médico en investigación, Clase IIa prevista. Hay una solicitud regulatoria en preparación. El producto está en evaluación clínica a través del ensayo SAFE-Discharge y aún no está disponible para suministro comercial. Aescia para Clínicas es una plataforma de flujo de trabajo y no es un dispositivo médico.',
    'footer.integrations': 'Integraciones',
    'footer.buy': 'Comprar',
    'footer.design_partner': 'Programa de socios de diseño',
    'footer.roi_calculator': 'Calculadora de ROI',
    'footer.security': 'Seguridad',
    'footer.faq': 'Preguntas frecuentes',
    'footer.privacy': 'Política de privacidad',
    'footer.terms': 'Términos de uso',
    'footer.nsw_supplier': 'Proveedor registrado del gobierno de Nueva Gales del Sur',
    'footer.nsw_supplier_aria': 'Perfil de proveedor registrado de Aescia en el mercado buy.nsw del gobierno de Nueva Gales del Sur (se abre en una ventana nueva)',
    'footer.solutions': 'Soluciones',
    'footer.solutions.bowel_prep': 'Calidad de la preparación intestinal',
    'footer.solutions.no_shows': 'Inasistencias a la colonoscopia',
    'footer.solutions.glp1': 'GLP-1 antes de la endoscopia',
    'footer.solutions.meds': 'Anticoagulantes y medicamentos para la diabetes',
    'footer.solutions.workflow': 'Flujo de trabajo previo al procedimiento',
    'footer.solutions.backfill': 'Relleno de agenda según la preparación',
    'footer.solutions.asc_fit': 'Evaluación de idoneidad para ASC',
    'footer.solutions.compare': 'Cómo se compara Aescia',
    ...
    'hospitals.status.body': 'Aescia para Hospitales tiene una clasificación Clase IIa prevista. Aún no se ha presentado una solicitud regulatoria. Hoy la colaboración es únicamente a través de contratos de evaluación y pilotos. Esta página no recluta participantes para el ensayo.',

    'hospitals.leadership.eyebrow': 'Dirección del ensayo',
    'hospitals.leadership.title': 'El investigador principal de SAFE-Discharge.',
    'hospitals.leadership.body': 'Aescia para Hospitales está en evaluación clínica a través del ensayo SAFE-Discharge. El investigador principal es un clínico-investigador cardiotorácico en ejercicio en el sitio del ensayo. Los asesores se nombran a medida que cada uno se incorpora y da su consentimiento.',
    'hospitals.leadership.woldendorp.name': 'Dr. Kei Woldendorp',
    ...
    'hospitals.leadership.woldendorp.role': 'Investigador principal del ensayo SAFE-Discharge en el Royal Prince Alfred Hospital, promovido por el Sydney Local Health District.',
    ...
    'hospitals.trial.body': 'Una evaluación prospectiva de un solo centro de Aescia para la monitorización tras el alta cardiotorácica, en marcha en el Royal Prince Alfred Hospital desde junio de 2026, con buenos resultados iniciales. Registrada en el Registro de Ensayos Clínicos de Australia y Nueva Zelanda y promovida por el Sydney Local Health District.',
    ...
    'clinics.features.item2.desc': 'Recordatorios programados en el idioma del paciente, una vía de confirmar y reprogramar integrada, y un aviso del mismo día sobre el que su recepción sí puede actuar. Cuando se abre un hueco, una lista corta de pacientes con la preparación lista para que la clínica la ofrezca.',
    ...
    'clinics.features.item5.desc': 'La noche anterior, el paciente puede subir una foto del inodoro a través de la aplicación web. La vía la coteja con una rúbrica fijada por clínicos y señala si la preparación parece ir bien, para que la clínica confirme o reprograme antes de que el paciente salga de casa.',
    ...
    'platformpg.body': 'Aescia es un solo motor con dos puertas. La misma autoría de vías componible, la misma capa de SMS hacia el paciente, el mismo equipo. La postura regulada del producto hospitalario eleva el estándar del producto para clínicas, y la velocidad de flujo de trabajo del producto para clínicas mantiene al producto hospitalario honesto sobre lo que un equipo ocupado de verdad adoptará.',
    ...
    'platformpg.ls.body': 'El motor ya codifica reglas a nivel de fármaco (GLP-1, SGLT2, DOAC, warfarina). Cualquier vía redactada por clínicos lo amplía. Las mismas primitivas (recolección estructurada, triaje redactado, entrega por SMS, exportación estructurada) son las que sustentan los programas modernos de apoyo al paciente, los registros y la recolección de evidencia del mundo real. Diseñamos para esta extensibilidad; no nombramos terapias que no hayamos desplegado.',
    ...
    'partners.body': 'Aescia está en un ensayo en marcha en la unidad cardiotorácica del Royal Prince Alfred Hospital en Sídney, con colaboraciones de investigación en institutos nombrados de Australia y Canadá. Publicamos las afiliaciones que hemos ganado, no muros de logotipos.',
    'partners.trial.label': 'Registro del ensayo',
    'partners.trial.value': 'ACTRN12625001425482',
    'partners.item1.name': 'Royal Prince Alfred Hospital',
    'partners.item1.role': 'Hospital universitario terciario del Sydney Local Health District. Su unidad de cirugía cardiotorácica aloja el sitio del ensayo SAFE-Discharge.',
    'partners.item2.name': 'The Baird Institute',
    ...
    'team.james.name': 'James Kurrle',
    'team.james.role': 'Fundador y director ejecutivo',
    'team.james.bio': 'Médico hospitalario con experiencia en cuidados críticos, que se formó y ejerció en la región rural de Nueva Gales del Sur (Wagga Wagga) y en Sídney. Es autor del motor de vías clínicas y dirige la estrategia de la empresa.',
    'team.vasken.name': 'Dr Vasken Dermardiros',
    'team.vasken.role': 'Cofundador y director de tecnología',
    'team.vasken.bio': 'Doctorado de la Universidad Concordia en aprendizaje automático aplicado a la energía de edificios. Dirige la seguridad, el alojamiento, la inferencia de inteligencia artificial, la integración con historias clínicas electrónicas y la infraestructura de autoría de vías que sostiene ambos productos.',
    'team.operating.eyebrow': 'Cargos de la empresa',
    'team.operating.title': 'Cargos estatutarios.',
    'team.shannon.name': 'Shannon Kurrle',
    ...
    'team.clinical.eyebrow': 'Dirección del ensayo',
    'team.clinical.title': 'SAFE-Discharge en el Royal Prince Alfred Hospital.',
    'team.clinical.body': 'Aescia para Hospitales está en un ensayo en marcha en el Royal Prince Alfred Hospital desde junio de 2026, con buenos resultados iniciales.',
    'team.kei.name': 'Dr. Kei Woldendorp',
    'team.kei.role': 'Investigador principal del ensayo SAFE-Discharge en el Royal Prince Alfred Hospital, promovido por el Sydney Local Health District',
    'team.kei.bio': 'BMed MBBS MPhil. Investigador cardiotorácico, The Baird Institute y Royal Prince Alfred Hospital.',
    'team.advisory.eyebrow': 'Asesoría',
    'team.advisory.title': 'Asesores.',
    'team.advisory.body': 'Los asesores se nombran a medida que cada uno se incorpora y da su consentimiento.',
    'team.advisory.body2': 'Para consultas sobre funciones de asesoría, use la página de contacto.',
    ...
    'updates.entry11.date': 'junio de 2026',
    'updates.entry11.tag': 'Ensayo',
    'updates.entry11.title': 'SAFE-Discharge comienza en el Royal Prince Alfred Hospital.',
    'updates.entry11.body': 'SAFE-Discharge, una evaluación prospectiva unicéntrica de Aescia for Hospitals en adultos en recuperación tras cirugía cardiotorácica, comenzó en la unidad de cirugía cardiotorácica del Royal Prince Alfred Hospital en junio de 2026. Está registrada en el Australian New Zealand Clinical Trials Registry y promovida por el Sydney Local Health District.',
    ...
    'updates.entry4.body': 'Solicitud MVPV25RD3347 presentada ante Investment NSW el 10 de abril de 2026. Programa de financiamiento de contrapartida para trabajo de comercialización. Decisión prevista para finales de junio de 2026.',
    ...
    'clinics.proof.stat1.label': 'Pacientes cancelados por preparación intestinal presuntamente inadecuada que completaron una colonoscopia o una prueba de heces en seis meses',
    'clinics.proof.stat1.value': '67 %',
    'clinics.proof.stat1.source': 'Hopkins 2020, Boston Medical Center (3 % cancelados por PIBP, 67 % completados en 6 meses)',
    ...
    'clinics.proof.stat2.source': 'Wang 2023, Transparency in Coverage (USD 989 a 1034, n=17 052 tarifas de ASC)',
