...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'partners.item1.role': 'Trial site, SAFE-Discharge',
    'partners.item2.name': 'The Baird Institute',
    'partners.item2.role': 'Cardiothoracic research',
    'partners.item3.name': 'Institute of Academic Surgery',
    'partners.item3.role': 'Academic surgery, RPAH',
  ...
  fr: {
    ...
    'partners.trial.value': 'ACTRN12625001425482',
    'partners.item1.name': 'Royal Prince Alfred Hospital',
    'partners.item1.role': 'Site d\'essai, SAFE-Discharge',
    'partners.item2.name': 'The Baird Institute',
    'partners.item2.role': 'Recherche cardiothoracique',
    'partners.item3.name': 'Institute of Academic Surgery',
    'partners.item3.role': 'Chirurgie académique, RPAH',
    'partners.item4.name': 'CHEO Research Institute',
