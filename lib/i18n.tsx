...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'updates.entry7.date': '24 April 2026',
    'updates.entry7.tag': 'Site',
    'updates.entry7.title': 'Team, partners, and a progress log on the site.',
    'updates.entry7.body': 'Published the operating team, added trial-site and research-institute affiliations, unified the contact flow, and started this updates log. Clinic pricing posture stays explicit: flat monthly by specialty, no seat-based math.',
    'updates.entry6.date': '24 April 2026',
    'updates.entry6.tag': 'Ethics',
    'updates.entry6.title': 'SAFE-Discharge ethics approval.',
    'updates.entry6.body': 'The SAFE-Discharge trial at Royal Prince Alfred Hospital has cleared human research ethics review. Site-specific governance and IT assessments follow. No trial recruitment on this site; enrolment happens through the RPAH cardiothoracic unit under ethics approval.',
    'updates.entry5.date': '15 April 2026',
    'updates.entry5.tag': 'Paediatrics',
    'updates.entry5.title': 'CHEO Research Institute PMF programme kickoff.',
    'updates.entry5.body': 'Aescia joined the Product-Market-Fit programme at the CHEO Research Institute in Ottawa, with a paediatric-respiratory post-discharge pathway as the working focus. Four candidate specialties under evaluation inside the programme: paediatric respiratory, paediatric cardiothoracic adjacency, paediatric gastroenterology, and paediatric oncology.',
    'updates.entry4.date': '14 April 2026',
    'updates.entry4.tag': 'Evidence',
    'updates.entry4.title': 'Bowel-preparation evidence base compiled.',
    'updates.entry4.body': 'Compiled a ten-document evidence base covering international guidelines, digital interventions, operational economics, diabetes and anticoagulant management, GLP-1, and special populations for colonoscopy preparation. Underpins the clinician-authored prep pathway shipping with the first paying clinic.',
    'updates.entry3.date': '13 April 2026',
    'updates.entry3.tag': 'Product',
    'updates.entry3.title': 'Aescia for Clinics MVP feature-complete.',
    'updates.entry3.body': 'End-to-end walkthrough across patient, clinician, and admin flows. Pathway authoring, multichannel reminders, GLP-1 overlay, diabetic and anticoagulant scenarios, recall tracking, and structured export. Production deploy follows once production database and EMR integration targets land.',
    'updates.entry2.date': '10 April 2026',
    'updates.entry2.tag': 'Grants',
    'updates.entry2.title': 'NSW MVP Ventures Round 3 submitted.',
    'updates.entry2.body': 'Application MVPV25RD3347 lodged with Investment NSW on 10 April 2026. Matched-funding programme for targeted commercialisation work. Decision expected late June 2026.',
    'updates.entry1.date': '28 March 2026',
    'updates.entry1.tag': 'Grants',
    'updates.entry1.title': 'TTRA submission.',
    'updates.entry1.body': 'Targeted Translation Research Accelerator application submitted. Three milestones, clinical evaluation and regulatory work, decision expected around September 2026.',
  ...
  fr: {
    ...
    'updates.entry7.date': '24 avril 2026',
    'updates.entry7.tag': 'Site',
    'updates.entry7.title': 'Équipe, partenaires et journal sur le site.',
    'updates.entry7.body': 'Publication de l\'équipe opérationnelle, ajout des affiliations site d\'essai et instituts de recherche, unification du formulaire de contact et ouverture de ce journal. La posture tarifaire cliniques reste explicite : mensuel forfaitaire par spécialité, pas de tarif par siège.',
    'updates.entry6.date': '24 avril 2026',
    'updates.entry6.tag': 'Éthique',
    'updates.entry6.title': 'Approbation éthique SAFE-Discharge.',
    'updates.entry6.body': 'L\'essai SAFE-Discharge au Royal Prince Alfred Hospital a passé la revue du comité d\'éthique. L\'évaluation spécifique au site et l\'évaluation informatique suivent. Ce site ne recrute pas ; l\'enrôlement se fait via le service de chirurgie cardiothoracique du RPAH sous approbation éthique.',
    'updates.entry5.date': '15 avril 2026',
    'updates.entry5.tag': 'Pédiatrie',
    'updates.entry5.title': 'Lancement du programme PMF au CHEO Research Institute.',
    'updates.entry5.body': 'Aescia a rejoint le programme Product-Market-Fit du CHEO Research Institute à Ottawa, avec un parcours post-sortie en pneumologie pédiatrique comme priorité de travail. Quatre spécialités candidates en évaluation dans le programme : pneumologie pédiatrique, adjacence cardiothoracique pédiatrique, gastroentérologie pédiatrique et oncologie pédiatrique.',
    'updates.entry4.date': '14 avril 2026',
    'updates.entry4.tag': 'Preuves',
    'updates.entry4.title': 'Base de preuves préparation intestinale compilée.',
    'updates.entry4.body': 'Compilation d\'une base de preuves en dix documents couvrant les recommandations internationales, les interventions numériques, l\'économie opérationnelle, la gestion du diabète et des anticoagulants, les GLP-1 et les populations particulières pour la préparation de coloscopie. Sous-tend le parcours de préparation rédigé par le clinicien livré avec la première clinique payante.',
    'updates.entry3.date': '13 avril 2026',
    'updates.entry3.tag': 'Produit',
    'updates.entry3.title': 'MVP d\'Aescia pour les cliniques terminé.',
    'updates.entry3.body': 'Parcours de bout en bout à travers les flux patient, clinicien et administrateur. Édition de parcours, rappels multicanal, superposition GLP-1, scénarios diabétiques et anticoagulants, suivi des rappels et export structuré. Le déploiement en production suit une fois la base de données et les cibles d\'intégration DME alignées.',
    'updates.entry2.date': '10 avril 2026',
    'updates.entry2.tag': 'Subventions',
    'updates.entry2.title': 'NSW MVP Ventures Round 3 soumis.',
    'updates.entry2.body': 'Demande MVPV25RD3347 déposée auprès d\'Investment NSW le 10 avril 2026. Programme de financement à part égale pour des travaux de commercialisation ciblés. Décision attendue fin juin 2026.',
    'updates.entry1.date': '28 mars 2026',
    'updates.entry1.tag': 'Subventions',
    'updates.entry1.title': 'Soumission TTRA.',
    'updates.entry1.body': 'Demande Targeted Translation Research Accelerator soumise. Trois jalons, travaux d\'évaluation clinique et de réglementation, décision attendue vers septembre 2026.',
