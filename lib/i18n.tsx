...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'updates.entry9.body': 'Published the operating team, added trial-site and research-institute affiliations, unified the contact flow, and started this updates log. Clinic pricing posture stays explicit: flat monthly by specialty, no seat-based math.',
    ...
    'clinics.proof.stat3.label': 'Base-rate inadequate colonoscopy preparation',
    'clinics.proof.stat3.value': '20–25%',
    'clinics.proof.stat3.source': 'Beran 2024, n=358,257',
  ...
  fr: {
    ...
    'updates.entry9.body': 'Publication de l\'équipe opérationnelle, ajout des affiliations site d\'essai et instituts de recherche, unification du formulaire de contact et ouverture de ce journal. La posture tarifaire cliniques reste explicite : mensuel forfaitaire par spécialité, pas de tarif par siège.',
    ...
    'clinics.proof.stat3.label': 'Taux de base de préparation inadéquate en coloscopie',
    'clinics.proof.stat3.value': '20 à 25 %',
    'clinics.proof.stat3.source': 'Beran 2024, n=358 257',
