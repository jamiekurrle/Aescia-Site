...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'clinics.proof.stat2.label': 'Modelled net upside for a three-site specialty practice',
    'clinics.proof.stat2.value': 'USD $180–220K per year',
    'clinics.proof.stat2.source': 'Aescia internal model, 2026',
  ...
  fr: {
    ...
    'clinics.proof.stat1.source': 'Mehta 2021',
    'clinics.proof.stat2.label': 'Gain net modélisé pour une pratique spécialisée à trois sites',
    'clinics.proof.stat2.value': '180 à 220 k$ US par an',
    'clinics.proof.stat2.source': 'Modèle interne Aescia, 2026',
