...
export const dict: Record<string, Record<string, string>> = {
  en: {
    ...
    'designpartner.cta.body': 'Tell us your scope volume and your current cancellation and no-show picture, or that you don\'t track it. We\'ll come back in under five business days with a one-page proposal: the outcome we\'d target for your site, the pilot shape, and the commercial structure.',
  ...
  fr: {
    ...
    'designpartner.cta.body': 'Indiquez-nous votre volume d\'examens et votre situation actuelle en matière d\'annulations et d\'absences, ou que vous ne la suivez pas. Nous reviendrons vers vous en moins de cinq jours ouvrés avec une proposition d\'une page : le résultat que nous viserions pour votre site, la forme du pilote et la structure commerciale.',
  ...
  es: {
    ...
    'designpartner.cta.body': 'Cuéntanos tu volumen de procedimientos y tu situación actual de cancelaciones y ausencias, o que no la registras. Te responderemos en menos de cinco días hábiles con una propuesta de una página: el resultado que buscaríamos para tu centro, la forma del piloto y la estructura comercial.',
    'designpartner.cta.button': 'Solicita ser socio de diseño',
  },
  zh: {
    ...
    'designpartner.cta.body': '告诉我们您的检查量以及您当前的取消和爽约情况，或者说明您并未追踪这些数据。我们将在五个工作日内回复您一份一页纸的方案：我们将为您的中心设定的目标结果、试点形式以及商业结构。',
  ...
  ar: {
    ...
    'designpartner.cta.body': 'أخبرنا بحجم مناظيرك ووضعك الحالي من حيث الإلغاء والتغيب، أو أنك لا تتتبّعه. سنعود إليك خلال أقل من خمسة أيام عمل بمقترح من صفحة واحدة: النتيجة التي سنستهدفها لمركزك، وشكل التجربة، والهيكل التجاري.',
    'designpartner.cta.button': 'قدِّم كشريك تصميم',
  },
  vi: {
    ...
    'designpartner.cta.body': 'Hãy cho chúng tôi biết khối lượng nội soi và tình hình hủy hẹn, vắng mặt hiện tại của bạn, hoặc rằng bạn không theo dõi điều đó. Chúng tôi sẽ phản hồi trong vòng chưa đến năm ngày làm việc với một đề xuất một trang: kết quả chúng tôi sẽ nhắm đến cho cơ sở của bạn, hình thức thử nghiệm và cấu trúc thương mại.',
