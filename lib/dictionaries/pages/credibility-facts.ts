export const dict: Record<string, Record<string, string>> = {
  en: {
    'credfacts.section.eyebrow': 'What a US ASC asks first',
  ...
  fr: {
    'credfacts.section.eyebrow': 'Ce qu\'un ASC américain demande en premier',
  ...
  es: {
    'credfacts.section.eyebrow': 'Lo que un ASC de EE. UU. pregunta primero',
  ...
  zh: {
    'credfacts.section.eyebrow': '美国 ASC 首先会问什么',
  ...
  ar: {
    'credfacts.section.eyebrow': 'ما الذي يسأل عنه ASC أمريكي أولاً',
  ...
  vi: {
    'credfacts.section.eyebrow': 'Điều một ASC ở Hoa Kỳ hỏi trước tiên',
