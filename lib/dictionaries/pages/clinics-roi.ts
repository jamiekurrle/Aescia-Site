...
export const dict: Record<string, Record<string, string>> = {
  en: {
    ...
    'roi.assumptions.price': 'Aescia price: set per engagement against your scope volume and held below the value above, so the contract is net positive at signature. Design partners start free until it proves itself. Talk to us for your rate.',
